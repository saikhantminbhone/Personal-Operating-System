import { IsString, IsEnum, IsOptional, IsNumber, Min, Max, IsDateString, IsArray, IsUUID, MinLength, ValidateIf } from 'class-validator'
...
export class CreateTaskDto {
  ...
  @ApiProperty({ required: false }) @IsOptional() @ValidateIf(o => o.goalId !== '') @IsUUID() goalId?: string
  @ApiProperty({ required: false }) @IsOptional() @ValidateIf(o => o.projectId !== '') @IsUUID() projectId?: string
